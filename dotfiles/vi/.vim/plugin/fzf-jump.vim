...
function! s:FzfJump(shell_command, with_line_number, ...)
  let flags = '-p'
  if a:0 > 0
  ...
  if !&hidden && &modified
    ...
    return
  elseif status == 1 " No lines to select from
