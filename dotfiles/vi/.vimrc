...
set smartcase
set incsearch
set nohlsearch " Let the auto-nohslearch plugin handle this,
               " otherwise there are unwanted effects
set mouse=
set hidden
set nojoinspaces
set nonumber
...
autocmd VimResized * wincmd =  " Equalize splits
autocmd VimEnter * :clearjumps " Fresh jumplist for every instance
