...
" -----------
fu! DiffOrig()
  if empty(expand('%')) || !exists("b:diff_active") && &buftype == "nofile"
  ...
  if !exists("b:diff_active") || b:diff_active == 0
    ...
    let l:orig_ft = &l:filetype
    let l:orig_name = expand('%')
    ...
    execute "silent file " . l:orig_name . " [Original]"
    let &l:filetype = l:orig_ft
...
nnoremap <silent> <Leader>D :call DiffOrig()<CR>
